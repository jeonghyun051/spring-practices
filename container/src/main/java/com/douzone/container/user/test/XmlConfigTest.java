...
public class XmlConfigTest {
	...
	public static void main(String[] args) {
		...
		// XML Bean Configuration(Explicit Scanning) 명시적
		// testBeanFactory02();
	...
	private static void testApplicationContext02() {
		...
		// type으로 가져오기
		// 같은 type의 빈이 2개 이상 있는 경우 type으로 가져오면 오류가 발생한다
		// 1. type + id
		// 2. type + name
		...
		// setter를 사용한 bean 가져오기3(List 프로퍼티)
	...
	private static void testApplicationContext01() {
		...
		System.out.println("testApplicationContext01:" + user1.getName());
